                  ...
                  <div className="flex flex-col md:flex-row md:space-x-6">
                      ...
                      <div className="flex-1 mb-4 md:mb-0">
                          <iframe
                              width="100%"
                              height="300"
                              src="https://www.youtube.com/embed/2_q7dEjlL-8?si=3w8j1RcBiKRN3xcC"
                      ...
                      <div className="flex-1">
                          ...
                          Charity and Crowdfunding Deception (CCFD) takes advantage of people’s goodwill, especially during natural disasters or crises. Fraudsters establish fake charities or manipulate crowdfunding platforms with fabricated stories to solicit donations, using emotional appeals to maximize contributions. They may impersonate legitimate organizations or create entirely fake identities to build credibility. The impact is twofold: donors lose their contributions, and genuine charities suffer from reduced public trust, making it harder for them to fulfill their mission.
                          </p>
                      </div>
                  </div>
              </div>
