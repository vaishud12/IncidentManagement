                  ...
                  <div className="flex flex-col md:flex-row md:space-x-6">
                      ...
                      <div className="flex-1 mb-4 md:mb-0">
                          <iframe
                              width="100%"
                              height="300"
                              src="https://www.youtube.com/embed/-yYJczm75g8?si=tIdkW-PzrasTAQvo"
                      ...
                      <div className="flex-1">
                          ...
                          Online Marketplace Fraud Risks (OMFR) involve fraudulent activities on popular e-commerce sites and peer-to-peer marketplaces. Scammers may create fake listings, offer counterfeit products, or exploit buyer and seller protections for personal gain. They may manipulate user reviews, impersonate other users, or engage in refund scams, deceiving both consumers and legitimate vendors. These frauds can erode trust in online shopping and lead to prolonged disputes and financial losses, affecting the integrity of online marketplaces.
                          </p>
                      </div>
                  </div>
              </div>
